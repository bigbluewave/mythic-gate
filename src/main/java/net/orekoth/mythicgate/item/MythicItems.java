...
public class MythicItems {
    ...
    public static final BroadswordItem METALLURGIUM_BROADSWORD = register("metallurgium_broadsword", new BroadswordItem(ToolMaterials.METALLURGIUM, 20f, 1.0f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).fireproof()));
    ...
    public static final BroadswordItem PALLADIUM_BROADSWORD = register("palladium_broadsword", new BroadswordItem(ToolMaterials.PALLADIUM, 13.5f, 1.0f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).fireproof()));
    ...
    public static final KatanaItem METALLURGIUM_KATANA = register("metallurgium_katana", new KatanaItem(ToolMaterials.METALLURGIUM, 12f, 1.4f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).fireproof()));
    ...
    public static final KatanaItem PALLADIUM_KATANA = register("palladium_katana", new KatanaItem(ToolMaterials.PALLADIUM, 8.5f, 1.4f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).fireproof()));
    ...
    public static final SpearItem METALLURGIUM_SPEAR = register("metallurgium_spear", new SpearItem(ToolMaterials.METALLURGIUM, 11.0f, 1.4f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).fireproof()));
    ...
    public static final SpearItem PALLADIUM_SPEAR = register("palladium_spear", new SpearItem(ToolMaterials.PALLADIUM, 7.5f, 1.4f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).fireproof()));
    ...
    public static final CustomBowItem ADAMANTITE_BOW = register("adamantite_bow", new CustomBowItem(ToolMaterials.ADAMANTITE, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1024), 24.0F, 1.65));
    public static final CustomBowItem AQUARIUM_BOW = register("aquarium_bow", new CustomBowItem(ToolMaterials.AQUARIUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(455), 25.0F, 1.1));
    public static final CustomBowItem BANGLUM_BOW = register("banglum_bow", new CustomBowItem(ToolMaterials.BANGLUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(260), 15.0F, 1.1));
    public static final CustomBowItem BRONZE_BOW = register("bronze_bow", new CustomBowItem(ToolMaterials.BRONZE, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(354), 30.0F, 1.15));
    public static final CustomBowItem CARMOT_BOW = register("carmot_bow", new CustomBowItem(ToolMaterials.CARMOT, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1130), 14.0F, 1.1));
    public static final CustomBowItem CELESTIUM_BOW = register("celestium_bow", new CustomBowItem(ToolMaterials.CELESTIUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(2270), 7.0F, 1.8));
    public static final CustomBowItem COPPER_BOW = register("copper_bow", new CustomBowItem(ToolMaterials.COPPER, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(125), 36.0F, 1.0));
    public static final CustomBowItem DURASTEEL_BOW = register("durasteel_bow", new CustomBowItem(ToolMaterials.DURASTEEL, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(800), 23.0F, 1.35));
    public static final CustomBowItem HALLOWED_BOW = register("hallowed_bow", new CustomBowItem(ToolMaterials.HALLOWED, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1984), 14.0F, 1.65));
    public static final CustomBowItem KYBER_BOW = register("kyber_bow", new CustomBowItem(ToolMaterials.KYBER, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(889), 24.0F, 1.2));
    public static final CustomBowItem METALLURGIUM_BOW = register("metallurgium_bow", new CustomBowItem(ToolMaterials.METALLURGIUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(3000), 11.0F, 2.0));
    public static final CustomBowItem MYTHRIL_BOW = register("mythril_bow", new CustomBowItem(ToolMaterials.MYTHRIL, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1564), 12.0F, 1.25));
    public static final CustomBowItem ORICHALCUM_BOW = register("orichalcum_bow", new CustomBowItem(ToolMaterials.ORICHALCUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(2048), 28.0F, 1.5));
    public static final CustomBowItem OSMIUM_BOW = register("osmium_bow", new CustomBowItem(ToolMaterials.OSMIUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(584), 24.0F, 1.1));
    public static final CustomBowItem PALLADIUM_BOW = register("palladium_bow", new CustomBowItem(ToolMaterials.PALLADIUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1234), 21.0F, 1.35));
    public static final CustomBowItem PROMETHEUM_BOW = register("prometheum_bow", new CustomBowItem(ToolMaterials.PROMETHEUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1472), 28.0F, 1.5));
    public static final CustomBowItem QUADRILLUM_BOW = register("quadrillum_bow", new CustomBowItem(ToolMaterials.QUADRILLUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(321), 33.0F, 1.1));
    public static final CustomBowItem RUNITE_BOW = register("runite_bow", new CustomBowItem(ToolMaterials.RUNITE, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1337), 19.0F, 1.3));
    public static final CustomBowItem STAR_PLATINUM_BOW = register("star_platinum_bow", new CustomBowItem(ToolMaterials.STAR_PLATINUM, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1300), 18.0F, 1.25));
    public static final CustomBowItem STEEL_BOW = register("steel_bow", new CustomBowItem(ToolMaterials.STEEL, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(600), 25.0F, 1.2));
    public static final CustomBowItem STORMYX_BOW = register("stormyx_bow", new CustomBowItem(ToolMaterials.STORMYX, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1305), 19.0F, 1.35));
